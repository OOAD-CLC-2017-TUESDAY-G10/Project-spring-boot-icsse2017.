...
<body>
    ...
    <div class="container">
        <div class="navbar-header">
            <img src="/resources/WELCOME TO ICSSE 2017_files/Banner Hoi nghi quoc te sua.jpg" style="width: 800px; height: 188px;">
            ...
            <div id='ctl06_portlet_6299a742-1878-4325-8536-4faefa3c1b4c' style="width:199px;float:right">
                <div>
                    <div class="search_phong">
                        ...
                        <input class="btsearch_phong" type="button" />
                    </div>
    ...
    <div class="container" style="height:350px;">
        <div class="slider-wrapper theme-default">
            <div id="slider" class="nivoSlider">
                <img src="/resources/WELCOME TO ICSSE 2017_files/HNQT3.jpg" title="" />
            </div>
        </div>
