...
<head><title>
	...
	<link href="../../../../css/show_img.css" rel="stylesheet" type="text/css" th:href="@{/css/show_img.css}"/>	
    <script type="text/javascript" src="../../../../css/jquery-1.7.2.min.js"  	th:src="@{/css/jquery-1.7.2.min.js}"></script>
    
    <script src="../../../../css/Common.js" type="text/javascript"  th:src="@{/css/Common.js}"></script>
    
    <script src="../../../../css/PagingContent.js" type="text/javascript"  th:src="@{/css/PagingContent.js}"></script>
    
	<link rel="shortcut icon" type="image/png" href="../../../../css/logo.png" th:href="@{/css/logo.png}"/>
	<link href="../../../../css/lightbox.css" rel="stylesheet" type="text/css" th:href="@{/css/lightbox.css}" />
    <script src="../../../../css/lightbox.min.js" type="text/javascript"  th:href="@{/css/lightbox.min.js}"></script>
    <link href="../../../../css/search_Article.css" rel="stylesheet"  th:href="@{/css/search_Article.css}" />
...
<link href="WebResourcee0ee.css?d=ytD-yNU6w7OB5aQbpzdcKJJ4smWyZMrK26w2o8npDQvDJ2icAgnw46NhWNMATnygLURPdF6r1twj4HqvCpovy2cbE23Jpa5bO0SD9RAs5_bYKKb1dSU8kaK__zLNU1OzkJIV0Q2&amp;t=636040235083572431" type="text/css" rel="stylesheet" class="Telerik_stylesheet" /></head>
...
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPaA8FDzhkNDcwM2E2NzY0YmVkMhgBBR5fX0NvbnRyb2xzUmVxdWlyZVBvc3RCYWNrS2V5X18WAgURUmFkV2luZG93TWFuYWdlcjEFOmN0bDA2JHBvcnRsZXRfODAwODg2YTgtY2NiNS00MGRkLTgxM2EtMmMwMmFjMGQyZTkyJFJhZE1lbnXeVCxEQo0PtEDMXWFGT3w3D5RWyg==" />
</div>
...
<div class="truycap_ute">
    <p>Visit month:
        <span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label4">2,508</span></p>
    <p class="line_footer"></p>
    <p>Visit total:<span id="ctl06_portlet_5c231c9e-b9b3-474f-bb01-834b95465666_Label1">5,986</span></p>
</div>
